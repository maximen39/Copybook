...
public class FragmentTrash  extends AbstractUpdatebleFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listItems.setAdapter(listActivity.getNoteList().getTrashList());
        return view;
    }
    ...
    public void onUpdateList() {
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ((ListActivity) getActivity()).getNoteList().getTrashList().notifyDataSetChanged();
            }
        });
    }
}
